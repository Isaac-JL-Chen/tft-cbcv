...
Usage:
  ...
  python3 -m script_download_data volatility volatility_data 
...
def download_volatility(config):
  ...
  # url = 'https://realized.oxford-man.ox.ac.uk/images/oxfordmanrealizedvolatilityindices.zip' ## dead
  url = 'https://github.com/onnokleen/mfGARCH/raw/master/data-raw/OxfordManRealizedVolatilityIndices.zip'
